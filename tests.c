...
int test_main () {
    ...
    for (int i = 0; i < sizeof(w2)/sizeof(int); i++) {
        for (int j = 0; j < sizeof(n2)/sizeof(int); j++) {
            ...
            strat = LOCK_FREE;
            lock_gen = NULL;
            double t1 = parallelFirewall(T/n2[j], n2[j], w2[i], 1, 10, 0);
            printf("lockfree, n = %d, speedup = %lf\n", n2[j], t0 / t1);

            strat = HOMEQUEUE;
            lock_gen = new_explock;
            double t2 = parallelFirewall(T/n2[j], n2[j], w2[i], 1, 10, 0);
            printf("homequeue, exp, n = %d, speedup = %lf\n", n2[j], t0 / t2);

            strat = HOMEQUEUE;
            lock_gen = new_taslock;
            double t3 = parallelFirewall(T/n2[j], n2[j], w2[i], 1, 10, 0);
            printf("homequeue, tas, n = %d, speedup = %lf\n", n2[j], t0 / t3);

            strat = RANDOMQUEUE;
            lock_gen = new_explock;
            double t4 = parallelFirewall(T/n2[j], n2[j], w2[i], 1, 10, 0);
            printf("randomqueue, exp, n = %d, speedup = %lf\n", n2[j], t0 / t4);

            strat = RANDOMQUEUE;
            lock_gen = new_taslock;
            double t5 = parallelFirewall(T/n2[j], n2[j], w2[i], 1, 10, 0);
            printf("randomqueue, tas, n = %d, speedup = %lf\n", n2[j], t0 / t5);

            strat = AWESOME;
            lock_gen = new_explock;
            double t6 = parallelFirewall(T/n2[j], n2[j], w2[i], 1, 10, 0);
    ...
    for (int i = 0; i < sizeof(w2)/sizeof(int); i++) {
        for (int j = 0; j < sizeof(n2)/sizeof(int); j++) {
            ...
            strat = LOCK_FREE;
            lock_gen = NULL;
            double t1 = parallelFirewall(T/n2[j], n2[j], w2[i], 0, 10, 0);
            printf("lockfree, n = %d, speedup = %lf\n", n2[j], t0 / t1);

            strat = HOMEQUEUE;
            lock_gen = new_explock;
            double t2 = parallelFirewall(T/n2[j], n2[j], w2[i], 0, 10, 0);
            printf("homequeue, exp, n = %d, speedup = %lf\n", n2[j], t0 / t2);

            strat = HOMEQUEUE;
            lock_gen = new_taslock;
            double t3 = parallelFirewall(T/n2[j], n2[j], w2[i], 0, 10, 0);
            printf("homequeue, tas, n = %d, speedup = %lf\n", n2[j], t0 / t3);

            strat = RANDOMQUEUE;
            lock_gen = new_explock;
            double t4 = parallelFirewall(T/n2[j], n2[j], w2[i], 0, 10, 0);
            printf("randomqueue, exp, n = %d, speedup = %lf\n", n2[j], t0 / t4);

            strat = RANDOMQUEUE;
            lock_gen = new_taslock;
            double t5 = parallelFirewall(T/n2[j], n2[j], w2[i], 0, 10, 0);
            printf("randomqueue, tas, n = %d, speedup = %lf\n", n2[j], t0 / t5);

            strat = AWESOME;
            lock_gen = new_explock;
            double t6 = parallelFirewall(T/n2[j], n2[j], w2[i], 0, 10, 0);
            printf("awesome, exp, n = %d, speedup = %lf\n", n2[j], t0 / t6);
        }
    }
